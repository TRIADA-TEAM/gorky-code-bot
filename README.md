...
│   │   ├── commands.py
│   │   └── callbacks.py
│   ├── settings/             # Настройки бота (классы состояний, загрузчики)
│   │   ├── classes.py
│   │   ├── keyboard.py
│   │   └── loader.py
...
5.  **Расчет времени в пути (`_get_route_travel_times_from_2gis`):**
...
1.  **Форматирование вывода (`_format_route_text`):**
...
4.  **Настройте переменные окружения:**
    ...
    2GIS_API_KEY="YOUR_2GIS_API_TOKEN"
    ```
